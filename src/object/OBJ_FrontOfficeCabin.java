...
public class OBJ_FrontOfficeCabin extends Entity {

    public OBJ_FrontOfficeCabin(GamePanel gp) {
        super(gp);
        down1 = setup("/objects/frontofficecabin", gp.tileSize * 4, gp.tileSize * 4);
        collision = true;
